...
Fork of **[Akiway/CP77_entSpawner](https://github.com/Akiway/CP77_entSpawner)** (which is a fork of **[justarandomguyintheinternet/CP77_entSpawner](https://github.com/justarandomguyintheinternet/CP77_entSpawner)**).

### Features in this fork

- **PhysX mesh from geometry cache** — streaming-sector collision nodes can use PhysX collision meshes sourced from the geometry cache.
   [How to use guide](docs/geometry_cache_collisions.md)
